...
#Wrangle and investigate
require(easystats)
describe_distribution(data1)
...
DIETS PLOT
```{r}
s2 = read.delim('/Users/alroy/Data/all_scats.txt')
s2[is.na(s2)] = 0
s2 = s2[,33:54]
s2 = t(t(s2) / colSums(s2))

s = read.delim('/Users/alroy/Data/all_scats.txt')
sp = paste(s[,29],s[,30])
s = s[,33:54]
s[is.na(s)] = 0
s = s / rowSums(s)
...
vert invert frug plant aquatic fungus
