...
#do we need these?
speciesE$population.density <- NULL #too many missing
speciesE$raoS <- NULL #same like simpson for now
speciesE$IUCN.status <- NULL #do we need this?
speciesE$mean.abundance <- NULL #should use median?
speciesE$diet.1 <- NULL #recoded?
```
