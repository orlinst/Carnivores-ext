...
h1 <- hist(estimates[,2], breaks = 25, main=paste("Histogram of estimates \n N=", nrow(estimates), "mean =", signif(mean(estimates[,2]))), xlab="Estimates", col="darkmagenta", cex.main=0.8)
