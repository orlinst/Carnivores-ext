...
imp <- mice(data.pc, 20, maxit = 5, method = c("pmm", "pmm", "pmm", "pmm", "pmm", "", "pmm", "polyreg", "pmm", "pmm", "pmm", "pmm", "pmm", "pmm", "pmm", "pmm","","","","","",""))
...
#measurement model
somatic=~BMR+mass.g+brain+litter
locomotion=~at + pc + home.range
#regression model
extant~somatic+locomotion'

dataX1$extant <- as.numeric(dataX1$extant)
