...
p <- ggplot(data_final1[-c(27,60),], aes(x=IUCN.status, y=BMR, fill=IUCN.status)) +   
...
ggplot(dataX1) + 
    geom_density_ridges(aes(x = BMR, y = activity, group = interaction(activity, extant),fill = extant), alpha = 0.7)  + theme(panel.grid.major = 
