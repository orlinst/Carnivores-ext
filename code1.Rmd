...
for (imps in 1:20){
    temptree <- tree[[i]]
    model1 <- with(imp, phylolm(extant ~ mass.g, get(paste0("dataX", imps)), temptree, method = c("logistic_MPLE")))}

for (imps in 1:20){
    temptree <- tree[[i]]

    as.mira(models) <- with(imp, phylolm(extant ~ mass.g, temptree, method = c("logistic_MPLE")))}
...
imp <- mice(data.pc, 20, maxit = 10, method = c("pmm", "pmm", "pmm", "pmm", "pmm", "pmm", "pmm", "pmm", "polyreg", "norm", "norm", "pmm", "pmm", "pmm", "pmm", "pmm", "pmm","","","","","",""))
