...
imp <- mice(data_final, 25, maxit = 50, method = c("", "", "pmm", "pmm", "logreg", "polyreg", "pmm", "pmm", "polyreg", "pmm", "pmm", "pmm", "pmm", "polyreg", "pmm", "pmm", "pmm", "pmm", "pmm", "pmm", "pmm", "logreg", "logreg","logreg","logreg","logreg","logreg"))


save(imp, file = "imp25x100.RData")
load("./imp25x100.Rdata")
