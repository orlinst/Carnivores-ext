...
data_final1$IUCN.status <- factor(data_final1$IUCN.status, levels=c("Least Concern", "Near Threatened", "Vulnerable", "Endangered", "Exctinct"))
p <- ggplot(data_final1[-c(27,60),], aes(x=IUCN.status, y=BMR, fill=IUCN.status)) +   
      ...
      scale_x_discrete(name ="IUCN Status", labels=c("Least Concern", "Near Threatened", "Vulnerable", "Endangered", "Exctinct"))
