...
```
regress.multi.impute1(tree, 25, extant ~ mass.g, 50)

regress.multi.impute1(tree, 5, extant ~ longevity + mass.g + litter, 20, alpha=0.001)
...
imp <- mice(data.pc, 25, maxit = 100, method = c("pmm", "pmm", "logreg", "pmm", "pmm", "polyreg", "pmm", "pmm", "pmm", "polyreg", "pmm", "pmm", "pmm", "pmm"))
